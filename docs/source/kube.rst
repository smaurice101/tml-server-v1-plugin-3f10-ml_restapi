Scaling [tml-server-v1-plugin-3f10-ml_restapi] With Kubernetes
===========================
...
Based on your TML solution [tml-server-v1-plugin-3f10-ml_restapi] - if you want to scale your application with Kubernetes - you will need to apply the following YAML files.

.. list-table::

   * - **YML File**
     - **Description**
   * - :ref:`tml-server-v1-plugin-3f10-ml_restapi.yml`
   ...
   * - :ref:`qdrant.yml`
     - This is the Qdrant deployment YAML.
       ...
       applied if using Step 9 DAG.
   * - :ref:`nginx-ingress-tml-server-v1-plugin-3f10-ml_restapi.yml`
     - If you are scaling your TML solution you must

       apply the nginx-ingresstml-server-v1-plugin-3f10-ml_restapi.yml; this yaml is 
...
.. code-block:: YAML
   ...
   kubectl apply -f kafka.yml -f secrets.yml -f mysql-storage.yml -f mysql-db-deployment.yml -f tml-server-v1-plugin-3f10-ml_restapi.yml

tml-server-v1-plugin-3f10-ml_restapi.yml
------------------------

.. important::
   Copy and Paste this YAML file: tml-server-v1-plugin-3f10-ml_restapi.yml - and save it locally.

   These YML files can also be found on GitHub at: https://github.com/smaurice101/raspberrypitss/tree/main/tml-airflow/dags/tml-solutions/tml-server-v1-plugin-3f10/ymls/tml-server-v1-plugin-3f10-ml_restapi
...
.. code-block::
   ...
   kubectl port-forward deployment/tml-server-v1-plugin-3f10-ml_restapi 6060:6060
...
.. important::
   ...
   **STEP 4:  Apply nginx-ingress-tml-server-v1-plugin-3f10-ml_restapi.yml to your kubernetes cluster.  First you need to save it locally then apply it:**

nginx-ingress-tml-server-v1-plugin-3f10-ml_restapi.yml
-------------
   ...
   .. code-block::
      ...
      kubectl apply -f nginx-ingress-tml-server-v1-plugin-3f10-ml_restapi.yml
