[tml-server-v1-plugin-3f10-ml_restapi] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [tml-server-v1-plugin-3f10-ml_restapi] container is NOT running**.

.. tip::
   You must have your [tml-server-v1-plugin-3f10-ml_restapi] container running before connecting to the Visualization and Airflow URLs.
...
[tml-server-v1-plugin-3f10-ml_restapi] Github Repo
---------------
...
.. important::
   https://tml-server-v1-plugin-3f10-ml_restapi.readthedocs.io
...
.. important::
   solution_preprocessing_ml_restapi_dag-tml-server-v1-plugin-3f10
...
.. important::
   VIPERHOST_PRODUCE=0.0.0.0, VIPERPORT_PRODUCE=5050, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=39359, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=36291, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=46803, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=46759, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=35705, HPDEHOST=127.0.1.1, HPDEPORT=34497, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=37437

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-9304-tml-server-v1-plugin-3f10-ml_restapi,solution_preprocessing_ml_restapi_dag-tml-server-v1-plugin-3f10, python-preprocess-1316-tml-server-v1-plugin-3f10-ml_restapi,solution_preprocessing_ml_restapi_dag-tml-server-v1-plugin-3f10, python-ml-3689-tml-server-v1-plugin-3f10-ml_restapi,solution_preprocessing_ml_restapi_dag-tml-server-v1-plugin-3f10, python-predict-2545-tml-server-v1-plugin-3f10-ml_restapi,solution_preprocessing_ml_restapi_dag-tml-server-v1-plugin-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-preprocess-agenticai, viper-ml, viper-predict
